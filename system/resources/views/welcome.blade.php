...
<head>
    ...
    <title>Info Rumah Susun Kota Magelang</title> 
...
<body class="mdc-theme--background"> 
    <div class="spinner-wrapper" id="preloader">
        <div class="spinner-container">
            <div class="spinner-outer">
                ...
                <p class="spinner-text">Rusunawa</p> 
            </div>
        </div>
    </div> 
    ...
    <main class="content-offset-to-top"> 
                ...
                <div class="properties-wrapper row"> 
                        ...
                        <div class="mdc-card property-item grid-item column-4 full-width-page">
                            ...
                            <div class="property-content-wrapper"> 
                                <div class="property-content">
                                    <div class="content">
                                        <h1 class="title"><a href="#">{{$unit->Nama_Unit}}</a></h1>
                                        <p class="row address flex-nowrap">
                                            <i class="material-icons text-muted">location_on</i>
                                            <span>{{$unit->alamat_rusun}}</span>
                                        </p>
                                        ...
                                        <div class="features mt-3">                    
                                            <p><span>Kode Rusun</span><span>{{$unit->Kode_Unit}}</span></p>
                                            <p><span>Lantai</span><span>{{$unit->Lantai}}</span></p>
                                        </div>   
                                    </div> 
                                    <div class="grow"></div>
                                    <div class="actions row between-xs middle-xs">
                                        <p class="row date mb-0">
                                            ...
                                            <span class="mx-2">{{$unit->nama_rusun}}</span>
                                        </p> 
                                        <a href="javascript:void(0);" class="mdc-button mdc-button--outlined">
                                            <span class="mdc-button__ripple"></span>
                                            <span class="mdc-button__label">{{$unit->Tipe_Sewa_Id}}</span> 
                                        </a>  
                                    </div>
                                </div>  
                            </div> 
                    ...
                    <div class="row center-xs middle-xs p-2 mt-2 w-100">                
                        <a href="javascript:void(0);" class="mdc-button mdc-button--raised">
                            <span class="mdc-button__ripple"></span>
                            <span class="mdc-button__label">unit lain</span> 
                        </a>
                    </div> 
                </div>  
            </div>  
        ...
        <div class="section agents">
            <div class="px-3">
                <div class="theme-container">
                    <h1 class="section-title">Pimpinan</h1> 
                            ...
                            <div class="swiper-wrapper">  
                                <div class="swiper-slide"> 
                                    <div class="mdc-card o-hidden">
                                        ...
                                        <div class="p-3">
                                            ...
                                            <p class="row middle-xs"><i class="material-icons primary-color" title="Organization">business</i><span class="mx-2 text-muted fw-500">Kasubag TU</span></p>
                                            <div class="row pb-3">
                                ...
                                <div class="swiper-slide"> 
                                    <div class="mdc-card o-hidden">
                                        ...
                                        <div class="p-3">
                                            <h2 class="fw-600">HANDINI RAHAYU, S.T.,M.Eng</h2> 
                                            <div class="row start-xs middle-xs ratings" title="15">      
                                                <i class="material-icons mat-icon-sm">star</i>
                                                <i class="material-icons mat-icon-sm">star</i>
                                                <i class="material-icons mat-icon-sm">star</i>
                                            ...
                                            <p class="mt-3 text-muted fw-500">Phasellus sed metus leo. Donec laoreet, lacus ut suscipit convallis, erat enim eleifend nulla, at sagittis enim urna et lacus.</p>                                    
                                            <p class="row middle-xs"><i class="material-icons primary-color" title="Organization">business</i><span class="mx-2 text-muted fw-500">Kadis Perkim</span></p>
                                           <div class="row pb-3">
                                                <div class="divider"></div>
                                            </div> 
                                ...
                                <div class="swiper-slide"> 
                                    <div class="mdc-card o-hidden">
                                        ...
                                        <div class="p-3">
                                            <h2 class="fw-600">BUDI PRAKOSA RADITO A.P., ST</h2> 
                                            <div class="row start-xs middle-xs ratings" title="15">      
                                                <i class="material-icons mat-icon-sm">star</i>
                                                <i class="material-icons mat-icon-sm">star</i>
                                                <i class="material-icons mat-icon-sm">star</i>
                                            ...
                                            <p class="mt-3 text-muted fw-500">Phasellus sed metus leo. Donec laoreet, lacus ut suscipit convallis, erat enim eleifend nulla, at sagittis enim urna et lacus.</p>                                    
                                            <p class="row middle-xs"><i class="material-icons primary-color" title="Organization">business</i><span class="mx-2 text-muted fw-500">KEPALA UPT</span></p>
